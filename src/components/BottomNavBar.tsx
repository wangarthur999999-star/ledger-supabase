...
export default function BottomNavBar({ activeTab, onTabChange }: BottomNavBarProps) {
  const { t } = useSettings();
  return (
    <nav className="fixed bottom-0 left-0 w-full z-50 bg-surface/90 backdrop-blur-2xl border-t border-surface-container shadow-[0_-12px_40px_-12px_rgba(0,0,0,0.15)] rounded-t-[32px]">

...
-- ============================================================================
-- RLS: 仅允许 anon/authenticated SELECT 读取历史数据
-- 写入由 service_role 绕过 RLS (scripts/update_rates.js)
-- ============================================================================
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      ...
      AND policyname = 'Public Read History'
  ) THEN
    CREATE POLICY "Public Read History" ON public.exchange_rates_history

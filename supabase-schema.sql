...
INSERT INTO user_profiles (id, display_name, email, phone, avatar_url) VALUES
  ('99999999-9999-9999-9999-999999999999', 'Demo User', 'demo@example.com', '+597 0000000', 'https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp&f=y');
...
-- Public read access for display data (anon + authenticated)
CREATE POLICY "public_read_products" ON products FOR SELECT USING (true);
CREATE POLICY "public_read_product_prices" ON product_prices FOR SELECT USING (true);
...
-- Scraper scripts use service_role key (bypasses RLS), no policy needed for INSERT/UPDATE
-- See scripts/ for update_rates.js and update_prices.js
